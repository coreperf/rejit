...
void Test() {
  ...
  TEST_First(1, "0123456789", "ab0123456789cd", 2, 12);
...
#undef x100
  ...
  TEST_First(1, ".123456789", "0123456789", 0, 10);
  TEST_First(1, "012345678.", "ab0123456789cd", 2, 12);
  ...
  TEST_First(1, "0123|abcd|efgh", "_abcd___", 1, 5);
  TEST_First(0, "0123|abcd|efgh", "_efgX___", 0, 0);
  TEST_First(1, "(0123|abcd)|efgh", "abcd", 0, 4);

  // Alternations and ERE.
  TEST(kMatchFull, 1, ")", ")");
  TEST_First(1, ")", "012)___", 3, 4);
  ...
  TEST_First(1, "0.*9", "0123456789", 0, 10);
  TEST_First(1, "0.*9", "____0123456789abcd", 4, 14);
  ...
  TEST_First(1, "a+", "012aaa_", 3, 6);
  TEST_First(1, "(a.)+", "012a.a_a-_", 3, 9);
  TEST_First(1, "(a.)+", "012a.a_a-_a-", 3, 9);
  ...
  TEST_First(1, "(1|22)+", "ABCD_111122221221221222222_XYZ", 5, 26);
  ...
  TEST_First(1, "[0-9]", "__________0__________", 10, 11);
  ...
  std::cout << "rejit tests done." << std::endl;
}
